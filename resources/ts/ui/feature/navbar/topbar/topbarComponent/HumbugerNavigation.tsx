...
import { humbugerLoginPages } from "../../pages/humbugerLoginPages";
import { humbugerLogoutPages } from "../../pages/humbugerLogoutPages";
import { useSelector } from "react-redux";
import { RootState } from "../../../../store/configureStore";
import { CategoryMenu } from "../../sidebar/sidebarComponent/categoryComplement/CategoryMenu";
import { CategoryListComplement } from "./CategoryListComplement";
...
export const HumbugerNavigation = (props: navigationProps) => {
    const {
        currentActivePage,
        MenuHandler,
        isOpen,
    ...
    const getTransitionItemsHandler = () => {
        ...
        return isLoggedIn ? humbugerLoginPages : humbugerLogoutPages;
    };
    ...
    return (
        <NavigationMenu style={navProps}>
            <CategoryListComplement
                setIsOpen={setIsOpen}
                categoryList={categoryList}
                isCategoryMode={isCategoryMode}
                setIsCategoryMode={setIsCategoryMode}
            />
