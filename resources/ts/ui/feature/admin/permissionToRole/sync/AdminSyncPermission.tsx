...
export const AdminSyncPermission = (
    ...
    const SyncPermissionHandler = async (data: any) => {
        const permissionIds = extractIdsFromSelectData(data.select);
        const res = await roleInteractor.syncPermissions(
            role.id,
            permissionIds
        );
        if (res.isFailure()) {
        ...
        <PermissionFormContainer>
            {isLoad ? (
                <Fragment>
                    ...
                    <Form onSubmit={handleSubmit(SyncPermissionHandler)}>
                        <Controller
                            name="select"
                            as={Select}
                            isMulti
