...
import {
    searchRoleObjType,
    roleSearchType
} from "../../role/search/roleSearchType";
import { InputPermissionToRole } from "./InputPermissionToRole";
import { AdminPermissionToRoleTable } from "./AdminPermissionToRoleTable";

export const AdminSearchPermissionToRole = (
    ...
    return (
        <SearchRoleContainer>
            <InputPermissionToRole />
            {isSearchObjLoaded ? (
                <AdminPermissionToRoleTable
                    roleList={roleList}
